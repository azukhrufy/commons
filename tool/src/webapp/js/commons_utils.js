commons.utils = {
    ...
    addPermissionsToPost: function (p) {
        ...
        p.canLike = commons.currentUserPermissions.likeCreate;
    ...
    addPermissionsToComment: function (c) {
        ...
        c.canLike = commons.currentUserPermissions.likeCreate;
    },
    ...
    renderPost: function (post, output) {
        ...
        $(document).ready(function () {
            ...
            //tambahan variable
            var like = $('#commons-post-like-link-' + post.id);
            
            like.click(function (e){
//                var click = 0;
                var count = $ ('#commons-show-like-link-' + post.id);
